 ...
 */
class CRM_Curatedgroupjoin_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Curatedgroupjoin_Upgrader(
        'com.pawpawworks.civicrm.curatedgroupjoin',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Curatedgroupjoin_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
